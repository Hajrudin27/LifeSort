...
export const DATA_DOMAINS = [
  ...
  },
  {
    ...
    storageSurfaces: ['async-storage:lifesort-trips', 'filesystem:document-directory/attachments'],
...
export const PERSISTENCE_SURFACES = [
  ...
  surface('async-storage:lifesort-expenses', 'async-storage', 'Zustand key lifesort-expenses', 'device', ['economy.expenses', 'economy.attachments'], ['store/useExpensesStore.ts']),
  ...
  surface('async-storage:lifesort-trips', 'async-storage', 'Zustand key lifesort-trips', 'device', ['travel.trips', 'travel.attachments'], ['store/useTripsStore.ts']),
  surface('async-storage:lifesort-warranties', 'async-storage', 'Zustand key lifesort-warranties', 'device', ['warranties.records', 'warranties.attachments'], ['store/useWarrantiesStore.ts']),
  ...
  surface('async-storage:lifesort-cycle', 'async-storage', 'Zustand key lifesort-cycle', 'device', ['cycle.user-health', 'cycle.reference-content'], ['store/useCycleStore.ts']),
  ...
  surface('filesystem:document-directory/attachments', 'filesystem', 'Local attachment directory', 'device', ['economy.attachments', 'travel.attachments', 'warranties.attachments'], ['utils/shared/attachmentStorage.ts']),
