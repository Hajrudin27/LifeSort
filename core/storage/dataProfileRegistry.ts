...
export const DATA_DOMAINS = [
  ...
  },
  {
    ...
    storageSurfaces: [
      ...
      'supabase-table:food_shopping_item_derivations',
...
export const PERSISTENCE_SURFACES = [
  ...
  surface('supabase-table:food_shopping_item_derivations', 'supabase-table', 'public.food_shopping_item_derivations', 'supabase', ['food.user-planning'], ['store/useFoodStore.ts']),
