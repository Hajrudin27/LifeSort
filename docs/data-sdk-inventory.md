...
| `expo-crypto` | ~57.0.2 | Expo | CSPRNG salt for PIN derivation and AES-GCM encryption for cycle health persistence | PIN salt; cycle health plaintext in memory during encryption/decryption | No | None |
