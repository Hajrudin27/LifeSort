...
export const PERSISTENCE_SURFACES = [
  ...
  surface('async-storage:lifesort-food-v2', 'async-storage', 'Zustand key lifesort-food-v2', 'device', ['food.user-grocery-finance', 'food.user-planning', 'food.seed-recipes', 'food.global-catalogue'], ['store/useFoodStore.ts'], { kind: 'versioned', owner: 'core/storage/migrations/foodIngredients.ts', currentVersion: 2, reason: 'APP-047 v0→v1 keeps recipe ingredient text verbatim; APP-050 v1→v2 keeps pantry quantity text verbatim as legacyQuantityText. Unknown shapes fail closed.' }),
